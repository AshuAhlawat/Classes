...
def onlineclassscript():
    ...
    while True:
        try:
            ...
            search.click()
            print("[Rishika] Entered Class")
            break
        except Exception as e:
            print("[Rishika] No Class in progress. ")
            time.sleep(180)
            onlineclassscript()
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    time.sleep(8)
                    search.click()
                    print("[Rishika] Poll Attended B")
                except Exception as e:
                    search = driver.find_element_by_css_selector('button[aria-label="Yes"]')
                    time.sleep(5)
                    search.click()
                    print("[Rishika] Poll Attended Yes")
            except Exception as e:
                print("[Rishika] class in progress...")
